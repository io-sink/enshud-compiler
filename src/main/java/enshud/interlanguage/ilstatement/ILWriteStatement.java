...
public class ILWriteStatement extends AbstractILStatement {

	public AbstractILOperand operand;

	public ILWriteStatement(AbstractILOperand operand) {
	...
	public String toString() {
		return String.format("write %s", operand);
	}
	...
	public void replaceOperandReference(AbstractILOperand oldOperand, AbstractILOperand newOperand) {
		if(!isOperandReplaceableByConstant())
